...
function create_photo(){
        ...
        for (var n=0 ;n<pic_animal.length;n++){
            ...
            if(n==0){
                ...
                p.innerHTML="<b>"+r2k(s)+"</b>";
                photo.appendChild(hr);
                photo.appendChild(p);
            }
            if(s!=pic_animal[n].split('（')[1].split('）')[0]){
                s=pic_animal[n].split('（')[1].split('）')[0]
                var p = document.createElement('p');
                var hr =document.createElement('hr');
                if(r2k(s.split('科')[0])==sub[count-1]){
                    te="i"+count
                    p.id=te;
                    count++;
                    p.innerHTML="<b>"+r2k(s)+"</b>";
