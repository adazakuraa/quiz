...
//植物
let pic_plant=["abunome（oobako科）","ainae（matinn科）","akabana（akabana科）","akane（akane科）","akaso（irakusa科）","akebonosou（rinndou科）","akigiri（siso科）","akikaramatu（kinnpouge科）","akinokirinnsou（kiku科）","akinonogesi（kiku科）","akkesisou（hiyu科）","amadokoro（kizikakusi科）","amerikahodoimo（mame科）","amerikasenndanngusa（kiku科）","aomizu（irakusa科）","aosuge（kayaturigusa科）","aretinogiku（kiku科）","aretiuri（uri科）","arimaumanosuzukusa（umanosuzukusa科）","arinotougusa（arinotougusa科）","asagao（hirugao科）","asaza（mitugasiwa科）","atumorisou（rann科）","awagoke（oobako科）","ayame（ayame科）","azesuge（kayaturigusa科）","azetougarasi（azetougarasi科）","azumatumekusa（bennkeisou科）","azumayamaazami（kiku科）","baikaikarisou（megi科）","baikamo（kinnpouge科）","baikeisou（syurosou科）","benibanaitiyakusou（tutuzi科）","bennkeisou（bennkeisou科）","biro-domouzuika（gomanohagusa科）","bonntennka（aoi科）","bonntokutade（tade科）","botannnekonomesou（yukinosita科）","butakusa（kiku科）","daikonnsou（bara科）","daimonnzisou（yukinosita科）","daisagisou（rann科）","danngiku（siso科）","dokudami（dokudami科）","ebiduru（budou科）","ebine（rann科）","ehimeayame（ayame科）","ennbisennnou（nadesiko科）","ennreisou（syurosou科）","enokigusa（toudaigusa科）","ezorinndou（rinndou科）","ezosirone（siso科）","filenames","gagabuta（mitugasiwa科）","gagaimo（kyoutikutou科）","gama（gama科）","gannkubisou（kiku科）","gennge（mame科）","ginnbaisou（azisai科）","ginnreika（sakurasou科）","ginnryousou（tutuzi科）","gisigisi（tade科）","gokiduru（uri科）","gomakusa（hamautubo科）","gomanohagusa（gomanohagusa科）","gouso（kayaturigusa科）","goyouitigo（bara科）","gozenntatibana（mizuki科）","gunnbaiduru（oobako科）","gunnnaihuuro（huurosou科）","hadakahoozuki（nasu科）","haedokusou（haedokusou科）","hagurosou（kitunenomago科）","hahakogusa（kiku科）","hakidamegiku（kiku科）","hakka（siso科）","hakobehoozuki（nasu科）","hakobe（nadesiko科）","hakusannhatazao（aburana科）","hamabennkeisou（murasaki科）","hamabisi（hamabisi科）","hamabossu（sakurasou科）","hamadaikonn（aburana科）","hamahatazao（aburana科）","hamakannzou（wasuregusa科）","hamamatuna（hiyu科）","hamanadesiko（nadesiko科）","hamaomoto（higannbana科）","hamasazi（isomatu科）","hamasuge（kayaturigusa科）","hamatumekusa（nadesiko科）","hamautubo（hamautubo科）","hamazeri（seri科）","hanabizekisyou（igusa科）","hanaikari（rinndou科）","hanamyouga（syouga科）","hanasinobu（hanasinobu科）","hanaudo（seri科）","hanazekisyou（tisimazekisyou科）","hanngesyou（dokudami科）","harii（kayaturigusa科）","hasikagusa（akane科）","hasiridokoro（nasu科）","hatazao（aburana科）","hekusokazura（akane科）","heraoobako（oobako科）","hetukarinndou（rinndou科）","hidakaennreisou（syurosou科）","hideriko（kayaturigusa科）","higannbana（higannbana科）","higotai（kiku科）","hikageinokozuti（hiyu科）","hikiyomogi（hamautubo科）","himegoyouitigo（bara科）","himehagi（himehagi科）","himehebiitigo（bara科）","himehiougizuisenn（ayame科）","himehuuro（huurosou科）","himekannsuge（kayaturigusa科）","himekikutabirako（kiku科）","himekugu（kayaturigusa科）","himemisohagi（misohagi科）","himemukasiyomogi（kiku科）","himenamiki（siso科）","himeodorikosou（siso科）","himerennge（bennkeisou科）","himesennnarihoozuki（nasu科）","himesirone（siso科）","himeyuri（yuri科）","himeziso（siso科）","hinagikyou（kikyou科）","hinanokannzasi（himehagi科）","hinanokinntyaku（himehagi科）","hinanosyakuzyou（hinanosyakuzyou科）","hinanousutubo（gomanohagusa科）","hiougi（ayame科）","hirugao（hirugao科）","hirumusiro（hirumusiro科）","hiruzakitukimisou（akabana科）","hisi（misohagi科）","hitomotosusuki（kayaturigusa科）","hitorisizuka（sennryou科）","hituzigusa（suirenn科）","hoozuki（nasu科）","hosikusa（hosikusa科）","hosoaogeitou（hiyu科）","hosobahaguma（kiku科）","hosobahamaakaza（hiyu科）","hosobakogomegusa（hamautubo科）","hotarubukuro（kikyou科）","hotarui（kayaturigusa科）","hotarukazura（murasaki科）","hoteiaoi（mizuaoi科）","hotokenoza（siso科）","hototogisu（yuri科）","houkigi（hiyu科）","hozakitukinukisou（suikazura科）","hukiyamituba（seri科）","huki（kiku科）","hukkisou（tuge科）","hukuousou（kiku科）","hukuzyusou（kinnpouge科）","husigurosennnou（nadesiko科）","hutabaaoi（umanosuzukusa科）","hutabamugura（akane科）","huziazami（kiku科）","huzibakama（kiku科）","huzihatazao（aburana科）","ibokusa（tuyukusa科）","ibukitoranoo（tade科）","igahoozuki（nasu科）","ikarisou（megi科）","ikema（kyoutikutou科）","imokatabami（katabami科）","inamorisou（akane科）","inugarasi（aburana科）","inugoma（siso科）","inukouzyu（siso科）","inunohanahige（kayaturigusa科）","inutade（tade科）","inutoubana（siso科）","irakusa（irakusa科）","isimikawa（tade科）","isogiku（kiku科）","isohusagi（hiyu科）","itadori（tade科）","itatisasage（mame科）","itibi（aoi科）","itirinnsou（kinnpouge科）","iwadaresou（kumatudura科）","iwagirisou（iwatabako科）","iwaityou（mitugasiwa科）","iwakagami（iwaume科）","iwanekonomesou（yukinosita科）","iwaninnzinn（seri科）","iwasenntousou（seri科）","iwasyazinn（kikyou科）","iwasyoubu（tisimazekisyou科）","iwatabako（iwatabako科）","iwautiwa（iwaume科）","iyohuuro（huurosou科）","iyokazura（kyoutikutou科）","i（igusa科）","kaikobaimo（yuri科）","kakinohagusa（himehagi科）","kakitubata（ayame科）","kakomahaguma（kiku科）","kamomerann（rann科）","kanabikisou（byakudann科）","kanikoumori（kiku科）","kanokosou（suikazura科）","karahanasou（asa科）","karakusanazuna（aburana科）","karamatusou（kinnpouge科）","karamusi（irakusa科）","karasubisyaku（satoimo科）","karasunoenndou（mame科）","karasunogoma（aoi科）","karasuuri（uri科）","kariganesou（siso科）","kasiwabahaguma（kiku科）","katabami（katabami科）","katakuri（yuri科）","katennsou（irakusa科）","kawagokesou（kawagokesou科）","kawamidori（siso科）","kawaraakaza（hiyu科）","kawaraketumei（mame科）","kawaranadesiko（nadesiko科）","kawaraninnzinn（kiku科）","kawarasaiko（bara科）","kawarasuge（kayaturigusa科）","kayaturigusa（kayaturigusa科）","kazaguruma（kinnpouge科）","kearitasou（hiyu科）","keibirann（kizikakusi科）","kibananoamana（yuri科）","kibananokawaramatuba（akane科）","kikasigusa（misohagi科）","kikuazami（kiku科）","kikumo（oobako科）","kikuzakiitige（kinnpouge科）","kikyou（kikyou科）","kinnbaisou（kinnpouge科）","kinnbaizasa（kinnbaizasa科）","kinnkouka（nogirann科）","kinnmizuhiki（bara科）","kirannsou（siso科）","kirenngesyouma（azisai科）","kirinnsou（bennkeisou科）","kirisimasyakuzyou（hinanosyakuzyou科）","kisumire（sumire科）","kitizyousou（kizikakusi科）","kitunenokamisori（higannbana科）","kitunenomago（kitunenomago科）","kiturihune（turihunesou科）","kiyosumiutubo（hamautubo科）","kizikakusi（kizikakusi科）","kizimusiro（bara科）","kizyorann（kyoutikutou科）","kobagibousi（kizikakusi科）","kobananabewari（byakubu科）","kobanokamomeduru（kyoutikutou科）","koitiyakusou（tutuzi科）","kokeotogiri（otogirisou科）","kokerinndou（rinndou科）","komikannsou（komikannsou科）","konisikisou（toudaigusa科）","kosikagiku（kiku科）","kosiogama（hamautubo科）","kouboumugi（kayaturigusa科）","kouhone（suirenn科）","kourinnka（kiku科）","kourinntannpopo（kiku科）","kouyabouki（kiku科）","kozyuzusuge（kayaturigusa科）","kugaisou（oobako科）","kumatudura（kumatudura科）","kumorann（rann科）","kurara（mame科）","kurinnsou（sakurasou科）","kurokumosou（yukinosita科）","kuroyatusirorann（rann科）","kurumabana（siso科）","kusaazisai（azisai科）","kusahuzi（mame科）","kusanagiogoke（kyoutikutou科）","kusanoou（kesi科）","kusaredama（sakurasou科）","kusasugikazura（kizikakusi科）","kusayatude（kiku科）","kusoninnzinn（kiku科）","kutinasigusa（hamautubo科）","kuwagatasou（oobako科）","kuwakusa（kuwa科）","kuzu（mame科）","maidurusou（kizikakusi科）","mamedutarann（rann科）","mamekamiture（kiku科）","manekigusa（siso科）","manntema（nadesiko科）","marubatyarumerusou（yukinosita科）","maruminourusi（toudaigusa科）","matukazesou（mikann科）","matumotosennnou（nadesiko科）","matumusisou（suikazura科）","medohagi（mame科）","mehaziki（siso科）","menamomi（kiku科）","metakarakou（kiku科）","mikadukigusa（kayaturigusa科）","mikosigaya（kayaturigusa科）","mikuri（mikuri科）","miminagusa（nadesiko科）","misimasaiko（seri科）","misogawasou（siso科）","misohagi（misohagi科）","misumisou（kinnpouge科）","mitiyanagi（tade科）","mitubaourenn（kinnpouge科）","mitugasiwa（mitugasiwa科）","miyakogusa（mame科）","miyamakatabami（katabami科）","miyamasirasuge（kayaturigusa科）","miyamatamurasou（siso科）","mizohoozuki（haedokusou科）","mizokakusi（kikyou科）","mizosoba（tade科）","mizuaoi（mizuaoi科）","mizubasyou（satoimo科）","mizuhiki（tade科）","mizukinnbai（akabana科）","mizuotogiri（otogirisou科）","mizutamasou（akabana科）","mizutoranoo（siso科）","momizigasa（kiku科）","morokosisou（sakurasou科）","mousenngoke（mousenngoke科）","mukagosou（rann科）","murasakikemann（kesi科）","murasakimimikakigusa（tanukimo科）","murasakinigana（kiku科）","murasakisennburi（rinndou科）","murasaki（murasaki科）","musikusa（oobako科）","musitorinadesiko（nadesiko科）","musitorisumire（tanukimo科）","musyarinndou（siso科）","nabena（suikazura科）","nabewari（byakubu科）","nagabanoisimotisou（mousenngoke科）","nagabonosirowaremokou（bara科）","nagahanasumire（sumire科）","nagamihinagesi（kesi科）","naginatakouzyu（siso科）","nannbanngiseru（hamautubo科）","nannbusou（megi科）","nanntennhagi（mame科）","nazuna（aburana科）","nekonomesou（yukinosita科）","nekonosita（kiku科）","nenasikazura（hirugao科）","nezibana（rann科）","nigakusa（siso科）","nigana（kiku科）","nipponninunohige（hosikusa科）","nira（negi科）","nisikisou（toudaigusa科）","niwazekisyou（ayame科）","noazami（kiku科）","noazuki（mame科）","nobinetidori（rann科）","nobiru（negi科）","nobudou（budou科）","nobuki（kiku科）","nodisya（suikazura科）","nogeitou（hiyu科）","nogirann（nogirann科）","noharanadesiko（nadesiko科）","nokogirisou（kiku科）","nosasage（mame科）","nougouitigo（bara科）","nourusi（toudaigusa科）","nozigiku（kiku科）","numadaikonn（kiku科）","nyohoutidori（rann科）","odorikosou（siso科）","okahiziki（hiyu科）","okatoranoo（sakurasou科）","okera（kiku科）","okinagusa（kinnpouge科）","ominaesi（suikazura科）","onamomi（kiku科）","oninoyagara（rann科）","onisimotuke（bara科）","oniyuri（yuri科）","oobako（oobako科）","oohutabamugura（akane科）","ooinunohuguri（oobako科）","ookanadamo（totikagami科）","ookinnreika（suikazura科）","ookinutasou（akane科）","oomatuyoigusa（akabana科）","oomomizigasa（kiku科）","ooreizinnsou（kinnpouge科）","oosennnari（nasu科）","ooyamahusuma（nadesiko科）","otogirisou（otogirisou科）","otokoesi（suikazura科）","ourenn（kinnpouge科）","oyamabokuti（kiku科）","raseitasou（irakusa科）","rasyoumonnkazura（siso科）","remonnegoma（siso科）","renngesyouma（kinnpouge科）","rennpukusou（rennpukusou科）","rennrisou（mame科）","rinndou（rinndou科）","rinnnesou（suikazura科）","ruiyoubotann（megi科）","rukousou（hirugao科）","rurihakobe（sakurasou科）","rurisou（murasaki科）","rurisyakuzyou（hinanosyakuzyou科）","ruritoranoo（oobako科）","ryuukinnka（kinnpouge科）","sabanoo（kinnpouge科）","sadekusa（tade科）","sagigoke（haedokusou科）","saihairann（rann科）","sakanerann（rann科）","sakuraisou（sakuraisou科）","sakurarann（kyoutikutou科）","sakurasoumodoki（sakurasou科）","sakurasou（sakurasou科）","sannkayou（megi科）","sarasinasyouma（kinnpouge科）","satumainamori（akane科）","sawagikyou（kikyou科）","sawarurisou（murasaki科）","saziomodaka（omodaka科）","seitakasuzumusisou（rann科）","seiyouaburana（aburana科）","seiyouhirugao（hirugao科）","sekisyoumo（totikagami科）","sennburi（rinndou科）","sennninnsou（kinnpouge科）","senntousou（seri科）","seribahiennsou（kinnpouge科）","seribasiogama（hamautubo科）","setubunnsou（kinnpouge科）","sidesyazinn（kikyou科）","simobasira（siso科）","simotukesou（bara科）","sinagawahagi（mame科）","siode（siode科）","sionn（kiku科）","sirahigesou（nisikigi科）","siraitosou（syurosou科）","siraneaoi（kinnpouge科）","sirobanahannsyouduru（kinnpouge科）","sirobanakamomeduru（kyoutikutou科）","sirobananekonomesou（yukinosita科）","sironosenndanngusa（kiku科）","sirotumekusa（mame科）","siroumaasatuki（negi科）","siroyomogi（kiku科）","siroza（hiyu科）","sitakisou（kyoutikutou科）","sokuzu（rennpukusou科）","suberihiyu（suberihiyu科）","suiba（tade科）","suisenn（higannbana科）","sunabikisou（murasaki科）","sunaduru（kusunoki科）","suzukouzyu（siso科）","suzumenoyari（igusa科）","suzumeuri（uri科）","suzumusibana（kitunenomago科）","suzurann（kizikakusi科）","syaga（ayame科）","syakuzyousou（tutuzi科）","syoubu（syoubu科）","syouzyoubakama（syurosou科）","syunnrann（rann科）","syusurann（rann科）","tagarasi（kinnpouge科）","tagasodesou（nadesiko科）","takanehannsyouduru（kinnpouge科）","takasaburou（kiku科）","takatoudai（toudaigusa科）","takenigusa（kesi科）","takesimarann（yuri科）","takonoasi（yukinosita科）","tamanokannaoi（umanosuzukusa科）","tanigikyou（kikyou科）","tannkirimame（mame科）","tanukimo（tanukimo科）","tanukinosyokudai（tanukinosyokudai科）","tateyamagiku（kiku科）","tatiaoi（aoi科）","tatidokoro（yamanoimo科）","tatigasiwa（kyoutikutou科）","tatikamebasou（murasaki科）","tatimo（arinotougusa科）","tatunamisou（siso科）","teisyousou（kiku科）","tennninnsou（siso科）","tidakesasi（yukinosita科）","tigoyuri（inusahurann科）","tinomegusa（ukogi科）","titikogusa（kiku科）","togakusisou（megi科）","tokinnsou（kiku科）","tomoesou（otogirisou科）","torikabuto（kinnpouge科）","totibaninnzinn（ukogi科）","totikagami（totikagami科）","toubana（siso科）","toudaigusa（toudaigusa科）","tubameomoto（yuri科）","tubokusa（seri科）","tukinukisou（suikazura科）","tukubanesou（syurosou科）","tumatorisou（sakurasou科）","tumerennge（bennkeisou科）","turiganeninnzinn（kikyou科）","turihunesou（turihunesou科）","turisyusurann（rann科）","turuaridoosi（akane科）","turubo（kizikakusi科）","turumao（irakusa科）","turuna（hamamizuna科）","turuninnzinn（kikyou科）","tururinndou（rinndou科）","tutiakebi2（rann科）","tutiakebi（rann科）","tutitorimoti（tutitorimoti科）","tuyukusa（tuyukusa科）","tyabohototogisu（yuri科）","tyabotumerennge（bennkeisou科）","tyokuzakimizu（irakusa科）","tyousennasagao（nasu科）","tyouzisou（kyoutikutou科）","tyouzitade（akabana科）","ubayuri（yuri科）","udo（ukogi科）","ukikusa（satoimo科）","umagoyasi（mame科）","umanomituba（seri科）","umebatisou（nisikigi科）","umegasasou（tutuzi科）","umimidori（sakurasou科）","unnrann（oobako科）","urasimasou（satoimo科）","usuyukisou（kiku科）","utubogusa（siso科）","waremokou（bara科）","warunasubi（nasu科）","wasabi（aburana科）","wasurenagusa（murasaki科）","watasuge（kayaturigusa科）","watigaisou（nadesiko科）","yabukannzou（wasuregusa科）","yabukarasi（budou科）","yabumame（mame科）","yabumao（irakusa科）","yabumyouga（tuyukusa科）","yaburann（kizikakusi科）","yaburegasamodoki（kiku科）","yaburegasa（kiku科）","yaemugura（akane科）","yakkosou（yakkosou科）","yakusimaotogiri（otogirisou科）","yamaai（toudaigusa科）","yamabukisou（kesi科）","yamabukisyouma（bara科）","yamahahako（kiku科）","yamahakka（siso科）","yamahanasou（yukinosita科）","yamahoozuki（nasu科）","yamainoimo（yamanoimo科）","yamakitunenobotann（kinnpouge科）","yamaodamaki（kinnpouge科）","yamarakkyou（negi科）","yamasyakuyaku（botann科）","yamatogusa（akane科）","yamayuri（yuri科）","yanagirann（akabana科）","yanagisubuta（totikagami科）","yanagitoranoo（sakurasou科）","yaseutubo（hamautubo科）","yatusirosou（kikyou科）","yawatasou（yukinosita科）","yomogi（kiku科）","yourakurann（rann科）","yousyuyamagobou（yamagobou科）","yukimibana（kitunenomago科）","yukinosita（yukinosita科）","yukizasa（kizikakusi科）","yuusuge（wasuregusa科）","zakurosou（zakurosou科）","zazennsou（satoimo科）","zeniaoi（aoi科）","zenibaaoi（aoi科）","zudayakusyu（yukinosita科）","zyakousou（siso科）","zyanohige（kizikakusi科）","zyourouhototogisu（yuri科）","zyuunihitoe（siso科）"]
