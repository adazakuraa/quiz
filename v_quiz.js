...
//植物
let pic_plant=["monnsutera（satoimo科）","dorasenahuragurannsu（kizikakusi科）","dorasenakonnsinnne（kizikakusi科）","karatea（kuzuukann科）","karaziumu（satoimo科）","annsuriumu（satoimo科）","potosu（satoimo科）","dhifennbakia（satoimo科）","azianntamu（inomotosou科）","oridururann（kizikakusi科）","sannseberia（kizikakusi科）","arekayasi（yasi科）","tirannzia（painappuru科）","syehurera（ukogi科）","pakira（aoi科）","koriusu（siso科）","hedera（ukogi科）","guri-nnnekkuresu（kiku科）","haorusia（turuborann科）","konofitumu（hamamizuna科）","hanakirinn（toudaigusa科）.jpeg","misebaya（bennkeisou科）","IMG_6268-1","karannkoe（bennkeisou科）","ekeberia（bennkeisou科）","syakobasabotenn（sabotenn科）","gekkabizinn（科）","kara-（satoimo科）","arusutoromeria（yurizuisenn科）","guroriosa（inusahurann科）","nerine（higannbana科）","huri-zia（ayame科）","aisuranndopopi-（kesi科）","sui-topi-（mame科）","hiperikamu（otogirisou科）","sutokku（aburana科）","ka-ne-syonn（nadesiko科）","tyokore-tokosumosu（kiku科）","ga-bera（kiku科）","tyaibu（higannbana科）","kinnrennka（nouzennharenn科）","rabennda-（siso科）","katorea（rann科）","kotyourann（rann科）","sirann（rann科）","inusahurann（inusahurann科）.png","guraziorasu（ayame科）","kurokkasu（ayame科）","kannna（kannna科）","agapannsasu（higannbana科）","kunnsirann（higannbana科）","amaririsu（higannbana科）","doitusuzurann（kizikakusi科）","musukari（kizikakusi科）","hiyasinnsu（kizikakusi科）","ranannkyurasu（kinnpouge科）","anemone（kinnpouge科）","kurisumasuro-zu（kinnpouge科）","kurematisu（kinnpouge科）","ozigisou（mame科）","rasserurupinasu（mame科）","syakuyaku（botann科）","syuukaidou（syuukaidou科）","zeraniumu（huurosou科）","huusennkazura（mukurozi科）","sui-toarissamu（aburana科）","bu-gennbiria（osiroibana科）","matubabotann（suberihiyu科）","po-tyuraka（suberihiyu科）","sennnitikou（hiyu科）","matubagiku（hamamizuna科）","housennka（turihunesou科）","innpatyennsu（turihunesou科）","sibazakura（hanasinobu科）","erika（tutuzi科）","azarea（tutuzi科）","sikuramenn（sakurasou科）","purimura（sakurasou科）","penntasu（akane科）","nitinitisou（kyoutikutou科）","nemofira（murasaki科）",
               "petyunia（nasu科）","nouzennkazura（nouzennkazura科）","ba-bena（kumatudura科）","kinngyosou（oobako科）","sarubia（siso科）","roberia（kikyou科）","torenia（azena科）","oogiku（kiku科）","kosumosu（kiku科）","mari-go-rudo（kiku科）","daria（kiku科）","yagurumagiku（kiku科）","de-zi-（kiku科）","saineria（kiku科）","sazannka（tubaki科）","karatati（mikann科）","nezumimoti（mokusei科）","kinnmokusei（mokusei科）","sanngozyu（gamazumi科）","motinoki（motinoki科）","taisannboku（mokurenn科）","yurinoki（mokurenn科）","tuta（budou科）","kanamemoti（bara科）","ennzyu（mame科）","biyouyanagi（otogirisou科）","sarusuberi（misohagi科）","senndann（senndann科）","mukuge（aoi科）","huyou（aoi科）",
               "gakuazisai（azisai科）","natutubaki（tubaki科）","kutinasi（akane科）","kyoutikutou（kyoutikutou科）","kidatityousennasagao（nasu科）","kuko（kuko科）","kiri（kiri科）","sitihennge（kumatudura科）","tarayou（motinoki科）","suikazura（suikazura科）","aberia（suikazura科）","kobusi（mokurenn科）","mokurenn（mokurenn科）","roubai（roubai科）","gekkeizyu（kusunoki科）","hiiraginanntenn（megi科）","botann（botann科）","yuzuriha（yuzuriha科）","hanazuou（mame科）","huzi（mame科）","enisida（mame科）","boke（bara科）","yamabuki（bara科）","satozakura（bara科）","yukiyanagi（bara科）","kodemari（bara科）","yamamomo（yamamomo科）","sidareyanagi（yanagi科）","popura（yanagi科）","mitumata（zinntyouge科）","zinntyouge（zinntyouge科）","hanamizuki（mizuki科）","doudanntutuzi（tutuzi科）","azumasyakunage（tutuzi科）","rairakku（mousei科）","renngyou（mokusei科）","yabutubaki（tubaki科）","hahakogusa（kiku科）","kakinohagusa（himehagi科）","himehagi（himehagi科）","tannkirimame（mame科）","sirotumekusa（mame科）","miyakogusa（mame科）","renngesou（mame科）","kourinntannpopo（kiku科）","habayamabokuti（kiku科）","noazami（kiku科）","butakusa（kiku科）","huzibakama（kiku科）","hakidamegiku（kiku科）","benibanaborogiku（kiku科）","huki（kiku科）","oogannkubisou（kiku科）","himemukasiyomogi（kiku科）","tokinnsou（kiku科）","yomogi（kiku科）","isogiku（kiku科）","asaza（mitugasiwa科）","mizokakusi（kikyou科）","hotarubukuro（kikyou科）","kikyou（kikyou科）","ominaesi（suikazura科）","rennpukusou（rennpukusou科）","tubokusa（seri科）","misimasaiko（seri科）","hanaudo（seri科）","tidomegusa（ukogi科）","tanukimo（tanukimo科）","unnrann（oobako科）","kikumo（oobako科）","touteirann（oobako科）","ooinunohuguri（oobako科）","awagoke（oobako科）","oobako（oobako科）","nannbanngiseru（hamautubo科）","hamautubo（hamautubo科）","sagigoke（haedokusou科）","haedokusou（haedokusou科）","kibanaakigiri（siso科）","sirone（siso科）","mizutoranoo（siso科）","naginatakouzyu（siso科）","utubogusa（siso科）",
               "hakka（siso科）","kakidoosi（siso科）","iwadaresou（kumatudura科）","kitunenomago（kitunenomago科）","biro-domouzuika（gomanohagusa科）","iwatabako（iwatabako科）","nenasikazura（hirugao科）","rukousou（hirugao科）","hamahirugao（hirugao科）","tyousennasago（nasu科）","hakobehoozuki（nasu科）","oosennnari（nasu科）","hoozuki（nasu科）","warunasubi（nasu科）","kobanokamomeduru（kyoutikutou科）","gagaimo（kyoutikutou科）","tyouzisou（kyoutikutou科）","himenae（matinn科）","sennburi（rinndou科）","rinndou（rinndou科）","hekusokazura（akane科）","hutabamugura（akane科）","yaemugura（akane科）","kibanakawaramatuba（akane科）","akane（akane科）","sunabikisou（murasaki科）","hamabennkeisou（murasaki科）","wasurenagusa（murasaki科）","yamarurisou（murasaki科）","yakkosou（yakkosou科）","akabanarurihakobe（sakurasou科）","rurihakobe（sakurasou科）","hamabossu（sakurasou科）","kusaredama（sakurasou科）","okatoranoo（sakurasou科）","sakurasou（sakurasou科）","turihunesou（turihunesou科）","tatiaoi（aoi科）","zeniaoi（aoi科）","itibi（aoi科）","arinotougusa（yukinosita科）","ooaraseitou（aburana科）","hamadaikonn（aburana科）","oranndagarasi（aburana科）","hamahatazao（aburana科）","nazuna（aburana科）","kakinegarasi（aburana科）","seiyouaburana（aburana科）","amatyaduru（uri科）","aretiuri（uri科）","suzumeuri（uri科）",
               "gokiduru（uri科）","karasuuri（uri科）","yabumao（irakusa科）","karamusi（irakusa科）","katennsou（irakusa科）","kuwakusa（kuwa科）","karahanasou（asa科）","kanamugura（asa科）","waremokou（bara科）","kinnmizuhiki（bara科）","kawarasaiko（bara科）","kizimusiro（bara科）","murasakikatabami（katabami科）","katabami（katabami科）","mizuotogiri（otogirisou科）","otogirisou（otogirisou科）","komikannsou（komikannsou科）","enokisou（toudaigusa科）","nisikisou（toudaigusa科）","natutoudai（toudaigusa科）","toudaigusa（toudaigusa科）","tatisumire（sumire科）","tatisubosumire（sumire科）","hamabisi（hamabisi科）","hiruzakitukimisou（akabana科）","oomatuyoigusa（akabana科）","mizukinnbai（akabana科）","tyouzitade（akabana科）","akabana（akabana科）","hisi（misohagi科）","kikasigusa（misohagi科）","misohagi（misohagi科）","gennnosyouko（hukurosou科）","nobudou（budou科）","yabugarasi（budou科）","tumerennge（bennkeisou科）","komotimannnenngusa（bennkeisou科）","takonoasi（yukinosita科）","tidakesasi（yukinosita科）","yukinosita（yukinosita科）","tutitorimoti（tutitorimoti科）","kanabikisou（byakudann科）","yousyuyamagobou（yamagobou科）","turuna（hamamizuna科）","suberihiyu（suberihiyu科）","zakurosou（zakurosu科）","akkesisou（hiyu科）","houkigi（hiyu科）","hamamatuna（hiyu科）","okahiziki（hiyu科）","akaza（hiyu科）","kawaraakaza（hiyu科）","siroza（hiyu科）","isohusagi（hiyu科）","inokoduti（hiyu科）","nogeitou（hiyu科）","hosoaogeitou（hiyu科）","nannbannhakobe（nadesiko科）","manntema（nadesiko科）","musitorinadesiko（nadesiko科）","hamanadesiko（nadesiko科）","kawaranadesiko（nadesiko科）","hakobe（nadesiko科）","miminagusa（nadesiko科）","hamahakobe（nadesiko科）","hamatumekusa（nadesiko科）","itadori（tade科）","gisigisi（tade科）","suiba（tade科）","sirobanasakuratade（tade科）","oobenitade（tade科）","mizosoba（tade科）","isimikawa（tade科）","mizuhiki（tade科）","mitiyanagi（tade科）","hamasazi（isomatu科）","mousenngoke（mousenngoke科）","hukkisou（tuge科）","kikemann（kesi科）","murasakikemann（kesi科）","yamabukisou（kesi科）","takenigusa（kesi科）","nagamihinagesi（kesi科）","kusanoou（kesi科）",
               "seribahiennsou（kinnpouge科）","okinagusa（kinnpouge科）","kazaguruma（kinnpouge科）","hansyouduru（kinnpouge科）","sennninsou（kinnpouge科）","botannduru（kinnpouge科）","nokaramatu（kinnpouge科）","inusyouma（kinnpouge科）","himeuzu（kinnpouge科）","yamatorikabuto（kinnpouge科）","nirinnsou（kinnpouge科）","syuumeigiku（kinnpouge科）","tagarasi（kinnpouge科）","umanoasigata（kinnpouge科）","aonokumatakerann（syouga科）","hanamyouga（syouga科）","mizuaoi（mizuaoi科）","ibokusa（tuyukusa科）","yabumyouga（tuyukusa科）","tuyukusa（tuyukusa科）","toumorokosi（ine科）","tigaya（ine科）","hiegeri（ine科）","tatunotumegaya（ine科）","danntiku（ine科）","siragegaya（ine科）","kouboumugi（kayaturigusa科）","hideriko（kayaturigusa科）","kayaturigusa（kayaturigusa科）","kougaizekisyou（igusa科）","i（igusa科）","nipponninunohige（hosikusa科）","siratamahosikusa（hosikusa科）","gama（gama科）","mikuri（mikuri科）","zyanohige（kizikakusi科）","yaburann（kiizkakusi科）","kusasugikazura（kizikakusi科）","amadokoro（kizikakusi科）","kobagibousi（kizikakusi科）","turubo（kizikakusi科）","nira（negi科）","asatuki（negi科）","hamaomoto（higannbana科）","suisenn（higannbana科）","natuzuisenn（higannbana科）","kitunenokamisori（higannbana科）","higannbana（higannbana科）","yabukannzou（wasurenagusa科）","niwazekisyou（ayame科）","himehiougizuisenn（ayame科）","syaga（ayame科）","ayame（ayame科）","sagisou（rann科）","oninoyagara（rann科）",
               "kinnrann（rann科）","nezibana（rann科）","huurann（rann科）","shunnran（rann科）","ebine（rann科）","kumagaisou（rann科）","tigoyuri（inusahurann科）","houtyakusou（inusahurann科）","hototogisu（yuri科）","kaikobaimo（yuri科）","kibananoamana（yuri科）","amana（yuri科）","ubayuri（yuri科）","yamayuri（yuri科）","katakuri（yuri科）","siode（siode科）","syouzyoubakama（syurosou科）","nagabasyurosou（syurosou科）","nagaimo（yamanoimo科）","hirumusiro（hirumusiro科）","sekisyoumo（totikagami科）","totikagami（totikagami科）","omodaka（omodaka科）","saziomodaka（omodaka科）","ukikusa（satoimo科）","oohannge（satoimo科）","urasimasou（satoimo科）","syoubu（syoubu科）","hitorisizuka（sennryou科）","sunaduru（kusunoki科）","umanosuzukusa（umanosuzukusa科）","tamanokannaoi（umanosuzukusa科）","hanngesyou（dokudami科）","dokudami（dokudami科）","zyunnsai（hagoromomo科）","hagoromomo（hagoromomo科）","onibasu（suirenn科）"]
