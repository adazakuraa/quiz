...
//植物
let pic_plant=["taimu（siso科）","tyaibu（higannbana科）","nasutatiumu（nouzennharenn科）","ro-zumari-（siso科）","product-sozai-mint_02","rabennda-（siso科）","kamomi-ru（kiku科）","katorea（rann科）","kotyourann（rann科）","sirann（sirann科）","inusahurann（inusahurann科）","kakitubata（ayame科）","guraziorasu（ayame科）","kurokkasu（ayame科）","kannna（kannna科）","agapannsasu（higannbana科）","kunnsirann（higannbana科）","amaririsu（higannbana科）","suisenn（higannbana科）","musukari（kizikakusi科）","hiyasinnsu（kizikakusi科）","ranannkyurasu（kinnpouge科）","anemone（kinnpouge科）","kurisumasuro-zu（kinnpouge科）","kurematisu（kinnpouge科）","rasserurupinasu（mame科）","syakuyaku（botann科）","syuukaidou（syuukaidou科）","biora（sumire科）","pannzi-（sumire科）","zeraniumu（huurosou科）","tatiaoi（aoi科）","haibisukasu（aoi科）","huusennkazura（mukurozi科）","habotann（aburana科）","sui-toarissamu（aburana科）","bu-gennbiria（osiroibana科）","keitou（hiyu科）","sennnitikou（hiyu科）","matubagiku（hamamizuna科）","innpatixennsu（turihunesou科）","sibazakura（hanasinobu科）","erika（tutuzi科）","azarea（tutuzi科）","kurimetutuzi（tutuzi科）","sikuramenn（sakurasou科）","purimura（sakurasou科）","penntasu（akane科）","nitinitisou（kyoutikutou科）","nemofira（murasaki科）","hoozuki（nasu科）","wasurenagusa（murasaki科）","petyunia（nasu科）","nouzennkazura（nouzennkazura科）","kinngyosou（oobako科）","mekisikannse-zi（siso科）","sarubia（siso科）","kikyou（kikyou科）","roberia（kikyou科）","torenia（azena科）","oogiku（kiku科）","kosumosu（kiku科）","mari-go-rudo（kiku科）","zinia（kiku科）","daria（kiku科）","yagurumagiku（kiku科）","miyakowasure（kiku科）","no-supo-ru（kiku科）","de-zi-（kiku科）","kinnsennka（kiku科）","saineria（kiku科）","potosu（satoimo科）","monnsutera（satoimo科）","dorasena・hureguransu（kizikakusi科）","dorasena・konnsinnna（kizikakusi科）","karaziumu（satoimo科）","annsuriumu（satoimo科）","oridururann（kizikakusi科）","sannseberia（kizikakusi科）","arekayasi（yasi科）","tirannzia（painappuru科）","bennzyaminn（kuwa科）","inndogomunoki（kuwa科）","syehurera（ukogi科）","pakira（aoi科）","koriusu（siso科）","poinnsetia（toudaigusa科）","dexyurannta（kumatudura科）","hedara（ukogi科）","haorusia（turuborann科）","guri-nnnekkuresu（kiku科）","konofitumu（hamamizuna科）","hanakirinn（toudaigusa科）","guraputopetarumu（bennkeisou科）","ekeberia（bennkeisou科）","karannkoe（bennkeisou科）","misebaya（bennkeisou科）",
"syakobasabotenn（sabotenn科）","gekkabizinn（sabotenn科）","niwatunogoke（tunogoke科）","himezyagoke（zyagoke科）","zenigoke（zenigoke科）","kosugigoke（sugigoke科）","yanoueakagoke（kinnsigoke科）","sugina（tokusa科）","inomotosou（inomotosou科）","inuwarabi（mesida科）","houraisida（inomotosou科）","nokisinobu（urabosi科）","kumazasa（ine科）","medake（ine科）","okamezasa（ine科）","higannbana（higannbana科）","yaburann（kizikakusi科）","turubo（kizikakusi科）","kayaturigusa（kayaturigusa科）","zyuzudama（ine科）","tikarasiba（ine科）","kazekusa（ine科）","ogi（ine科）","tidimizasa（ine科）","kanamugura（asa科）","mizuhiki（tade科）","ooketade（tade科）","inutade（tade科）","hinatainokozuti（hiyu科）","siroza（hiyu科）","hiyodorizyougo（nasu科）","urikusa（azena科）","kitunenomago（kitunenomago科）","huzibakama（kiku科）","butakusa（kiku科）","kikuimo（kiku科）","benibanaborogiku（kiku科）","seitakaawadatisou（kiku科）","yomogi（kiku科）","ooonamomi（kiku科）","akinonogesi（kiku科）","kosenndanngusa（kiku科）","amerikasenndanngusa（kiku科）","housennka(turihunesou科)","dokudami(dokudami科)","nokannzou(turuborann科)","nezibana(rann科)","tamasudare(higannbana科)","zyanohige(kizikakusi科)","tuyukusa(tuyukusa科)","yukinosita(yukinosita科)","kobannsou(ine科)","kusanoou(kesi科)","takenigusa(kesi科)","yabugarasi(budou科)","karasuuri(uri科)","kuzu(mame科)","kawaraketumei(mame科)","kusudamatumekusa(mame科)","sirotumekusa(mame科)","konisikisou(toudaigusa科)","amerikahuuro(hukurosou科)","hiruzakitukimisou(akabana科)","oomatuyoigusa(akabana科)","itibi(aoi科)","zeniaoi(aoi科)","itadori(tade科)","suiba(tade科)","isimikawa(tade科)","mamakonoshirinugui(tade科)","himeturusoba(tade科)","osiroibana(osiroibana科)","suberihiyu(suberihiyu科)",
"musitorinadesiko(nadesiko科)","oranndamiminagusa(nadesiko科)","yousyuyamagobou(yamagobou科)","hekusokazura(akane科)","yaemugura(akane科)","rukousu(hirugao科)","hirugao(hirugao科)","warunasubi(nasu科)","hakobehoozuki(nasu科)","heraoobako(oobako科)","oobako(oobako科)","hanatoranoo(siso科)","yanagihanagasa(kumatudura科)","kikyousou(kikyou科)","biro-domouzuika(gomanohagusa科)","aragehanngonnsou(kiku科)","hireazami(kiku科)","kibanakosumosu(kiku科)","harusyagiku(kiku科)","ookinnkeigiku(kiku科)","kourinntannpopo(kiku科)","peraperayomena(kiku科)","hakidamegiku(kiku科)","yomena(kiku科)","noborogiku(kiku科)","himemukasiyomogi(kiku科)","ooaretinogiku(kiku科)","aretinogiku(kiku科)","himezyoonn(kiku科)","yabuzirami(seri科)","niwazekisyou(ayame科)","syaga(ayame科)","hatakenira(higannbana科)","hananira(higannbana科)","ooamana(kizikakusi科)","tokiwatuyukusa(tuyukusa科)","suzumenoyari(igusa科)","tigaya(ine科)","nagamihinagesi(kesi科)","mekisikomannnenngusa(bennkeisou科)","miyakogusa(mame科)","karasunoenndou(mame科)","rengesou(mame科)","imokatabami(katabami科)","katabami(katabami科)","toudaigusa(toudaigusa科)","tanetukebana(aburana科)","syokatusai(aburana科)","seiyouaburana(aburana科)","nazuna(aburana科)","hakobe(nadesiko科)","tumekusa(nedesiko科)","kyuurigusa(murasaki科)","hotokenoza(siso科)","himeodorikosou(siso科)","tokiwahaze(sagigoke科)","tutabaunnrann(oobako科)","matubaunnrann(oobako科)","hurasabasou(oobako科)","ooinunohuguri(oobako科)","seiyoutannpopo(kiku科)","hahakogusa(kiku科)","nogesi(kiku科)","haruzionn(kiku科)","koonitabirako(kiku科)","onitabirako(kiku科)","butana(kiku科)","zisibari(kiku科)"]
