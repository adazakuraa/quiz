...
//植物
let pic_plant=["sazannka（tubaki科）","karatati（mikann科）","nezumimoti（mokusei科）","kinnmokusei（mokusei科）","sanngozyu（gamazumi科）","motinoki（motinoki科）","taisannboku（mokurenn科）","yurinoki（mokurenn科）","tuta（budou科）","kanamemoti（bara科）","ennzyu（mame科）","biyouyanagi（otogirisou科）","sarusuberi（misohagi科）","senndann（senndann科）","mukuge（aoi科）","huyou（aoi科）","gakuazisai（azisai科）","natutubaki（tubaki科）","kutinasi（akane科）","kyoutikutou（kyoutikutou科）","kidatityousennasagao（nasu科）","kuko（kuko科）","kiri（kiri科）","sitihennge（kumatudura科）","tarayou（motinoki科）","suikazura（suikazura科）","aberia（suikazura科）","kobusi（mokurenn科）","mokurenn（mokurenn科）","roubai（roubai科）","gekkeizyu（kusunoki科）","hiiraginanntenn（megi科）","botann（botann科）","yuzuriha（yuzuriha科）","hanazuou（mame科）","huzi（mame科）","enisida（mame科）","boke（bara科）","yamabuki（bara科）","satozakura（bara科）","yukiyanagi（bara科）","kodemari（bara科）","yamamomo（yamamomo科）","sidareyanagi（yanagi科）","popura（yanagi科）","mitumata（zinntyouge科）","zinntyouge（zinntyouge科）","hanamizuki（mizuki科）","doudanntutuzi（tutuzi科）","azumasyakunage（tutuzi科）","rairakku（mousei科）","renngyou（mokusei科）","yabutubaki（tubaki科）","hahakogusa（kiku科）","kakinohagusa（himehagi科）","himehagi（himehagi科）","tannkirimame（mame科）","sirotumekusa（mame科）","miyakogusa（mame科）","renngesou（mame科）","kourinntannpopo（kiku科）","habayamabokuti（kiku科）","noazami（kiku科）","butakusa（kiku科）","huzibakama（kiku科）","hakidamegiku（kiku科）","benibanaborogiku（kiku科）","huki（kiku科）","oogannkubisou（kiku科）","himemukasiyomogi（kiku科）","tokinnsou（kiku科）","yomogi（kiku科）","isogiku（kiku科）","asaza（mitugasiwa科）","mizokakusi（kikyou科）","hotarubukuro（kikyou科）","kikyou（kikyou科）","ominaesi（suikazura科）","rennpukusou（rennpukusou科）","tubokusa（seri科）","misimasaiko（seri科）","hanaudo（seri科）","tidomegusa（ukogi科）","tanukimo（tanukimo科）","unnrann（oobako科）","kikumo（oobako科）","touteirann（oobako科）","ooinunohuguri（oobako科）","awagoke（oobako科）","oobako（oobako科）","nannbanngiseru（hamautubo科）","hamautubo（hamautubo科）","sagigoke（haedokusou科）","haedokusou（haedokusou科）","kibanaakigiri（siso科）","sirone（siso科）","mizutoranoo（siso科）","naginatakouzyu（siso科）","utubogusa（siso科）",
